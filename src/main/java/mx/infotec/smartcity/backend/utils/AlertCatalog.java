...
public class AlertCatalog {
    ...
    public static String setAlertTemperature(String valor){
        ...
        if(temperature<=-40){
            return ("Temperature: " + valor + " °C <br> Classed as: Hyper-glacial. <br> Advice: Thermal very cold and extreme cold stress.");
        }
        else if(temperature>=-39&&temperature<=-20){
            return ("Temperature: " + valor + " °C <br> Classed as: Glacial. <br> Advice: Thermal sensitivity cold and strong cold stress.");
        }
        else if(temperature>=-19&&temperature<=-10){
            return ("Temperature: " + valor + " °C <br> Classed as: Extremely cold. <br> Advice: Thermal sensitivity cool and moderate cold stress.");
        }
        else if(temperature>=-9&&temperature<=-1){
            return ("Temperature: " + valor + " °C <br> Classed as: Very cold. <br> Advice: Thermal sensitivity slightly cool and slight cold stress.");
        }
        else if(temperature>=0&&temperature<=13){
            return ("Temperature: " + valor + " °C <br> Classed as: Cold. <br> Advice: Thermal sensitivity comfortable and no thermal stress.");
        }
        else if(temperature>=27&&temperature<=32){
            return ("Temperature: " + valor + " °C <br> Classed as: Caution. <br> Advice: Fatigue is possible with prolonged exposure and activity. Continuing activity could result in heat cramps.");
        }
        else if(temperature>=33&&temperature<=41){
            return ("Temperature: " + valor + " °C <br> Classed as: Alert. <br> Advice: Heat cramps and heat exhaustion are possible. Continuing activity could result in heat stroke.");
        }
        else if(temperature>=42&&temperature<=54){
            return ("Temperature: " + valor + " °C <br> Classed as: Warning. <br> Advice: Heat cramps and heat exhaustion are likely; heat stroke is probable with continued activity.");
        }
        else if(temperature>54){
            return("Temperature: " + valor + " °C <br> Classed as: Danger. <br> Advice: Extreme danger, heat stroke is imminent.");
        }
    ...
    public static String setAlertHumidity(String valor){
        ...
        if(humidity<=29){
            return("Relative humidity: "+ valor + " %. <br> Advice: No discomfort.");
        }else if(humidity>=30&&humidity<=39){
            return("Relative humidity: "+ valor + " %. <br> Advice: Some discomfort.");
        }else if(humidity>=40&&humidity<=45){
            return("Relative humidity: "+ valor + " %. <br> Advice: Great discomfort: avoid exertion.");
        }else if(humidity>=46&&humidity<=54){
            return("Relative humidity: "+ valor + " %. <br> Advice: Dangerous.");
        }else if(humidity>54){
            return("Relative humidity: "+ valor + " %. <br> Advice: Heat stroke imminent.");
        }
